...
const sumPrice = (price) => {
   miniCartSum.textContent = `${sumOfPrice+= price}` 
}
         ...
         for (let dataItem of cartData) {
            ...
            <article class="mini-cart__product mini-product">
              ...
              <div class="mini-product__content">
                ...
                <button class="btn-reset mini-product__delete" data-price=${dataItem.price}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
